...
const personalitiesCalculatorResultsValidator = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const validationRule = Object.assign({ personsTypes: 'required|array|size:2', 'personsTypes.*': 'required|string|in:ISFJ,ISTJ,INFJ,INTJ,ISFP,ISTP,INFP,INTP,ESFJ,ESTJ,ENFJ,ENTJ,ESFP,ESTP,ENFP,ENTP' }, helpers_1.testsValidationCommonObject);
