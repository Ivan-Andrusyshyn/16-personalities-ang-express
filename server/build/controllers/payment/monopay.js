...
//
//
const updateDocModel = (res, updatedDoc, invoiceId, testName) => __awaiter(void 0, void 0, void 0, function* () {
    const now = Date.now();
    ...
    const expiredAt = paidAt + TWO_HOURS;
    return res.json({
        invoiceId,
        status: 'success',
        testName,
...
const checkStatusPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if ((updatedDoc === null || updatedDoc === void 0 ? void 0 : updatedDoc.status) === 'success') {
            yield updateDocModel(res, updatedDoc, invoiceId, testName);
        }
        else {
            return res.json({
                invoiceId,
