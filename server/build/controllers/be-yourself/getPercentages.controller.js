...
const postPercentagesAndType = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const amountQuestions = be_yourself_service_1.default.amountQuestionsInType((0, test_1.default)());
        const { scores, percentages } = be_yourself_service_1.default.countPersonPercentages(answers, amountQuestions);
        const personType = be_yourself_service_1.default.getCodedTypeName(scores);
        //
        res.status(200).send({
