...
const _16_personalities_calculator_service_1 = __importDefault(require("../../../../services/16-personalities-calculator.service"));
...
const getPersonalitiesCalculatorResults = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const personsTypes = req.body.personsTypes;
        ...
        if (scoreResult) {
            const relationshipsType = _16_personalities_calculator_service_1.default.getTypeRelationshipByScore(scoreResult);
